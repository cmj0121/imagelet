...
// stays untouched.
var navBodyFragment = []byte(`<button type="button" class="imagelet-nav-prev" data-imagelet-nav="-1" aria-label="Previous day">‹</button>
